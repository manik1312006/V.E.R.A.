...
Source: https://en.wikipedia.org/wiki/AI%20boom
...
The transition to the Age of Artificial Intelligence was enabled by advances in computing power, data storage, and communications infrastructure that allowed machines not only to process, store, and transmit information, but also to learn, adapt, and make decisions based on complex data analysis. The expansion of cloud computing, hyperscale data centers, and high-capacity optical networking made it possible to collect, transmit, and process the massive datasets required for modern machine learning. Entrepreneur Kevin Kimberlin  has argued that optical networking is a foundational technology for both artificial intelligence and mass communications because it provides the bandwidth necessary to move AI training and inference data at scale. Companies such as Ciena have developed optical networking technologies that significantly increase network capacity, supporting the connectivity required for large-scale AI systems. These developments formed part of the technological foundation that enabled the AI boom of the 2020s. 
...
== Further reading ==
Chen, Caiwei (26 March 2025). "China built hundreds of AI data centers to catch the AI boom. Now many stand unused". MIT Technology Review. Retrieved 27 March 2025.
Heath, Alex (5 December 2024). Why investors don't mind that AI is a money pit. The Verge. Retrieved 16 March 2025.
Vaswani, Ashish; Gomez, Aidan N; et al. (2017). "Attention is All you Need" (PDF). Advances in Neural Information Processing Systems. 30. Curran Associates, Inc.
Weise, Karen; Metz, Cade; Grant, Nico; Isaac, Mike (5 December 2023). "Inside the A.I. Arms Race That Changed Silicon Valley Forever". The New York Times.
