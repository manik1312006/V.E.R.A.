...
Source: https://en.wikipedia.org/wiki/Industrial%20robot

An industrial robot is a robot used for manufacturing. Industrial robots are automated, programmable and capable of movement on three or more axes.
...
In the year 2024, an estimated 4,663,698 industrial robots were in operation worldwide according to the International Federation of Robotics (IFR).
...
=== Autonomous robot ===
An autonomous robot is a robot that acts without recourse to human control. The first autonomous robots were known as Elmer and Elsie and constructed in the late 1940s by W. Grey Walter. They were the first robots that were programmed to "think" the way biological brains do, intended to have free will. Elmer and Elsie were often labeled as tortoises because of how they were shaped and the manner in which they moved. They were capable of phototaxis which is the movement that occurs in response to light stimulus.
...
Positional commands The robot can be directed to the required position using a graphical user interface or text based commands in which the required x-y-z position may be specified and edited.
...
== Market structure ==
According to the International Federation of Robotics (IFR) study World Robotics 2025, there were about 4,663,698 operational industrial robots by the end of 2024. For the year 2018 the IFR estimates the worldwide sales of industrial robots with US$16.5 billion. Including the cost of software, peripherals and systems engineering, the annual turnover for robot systems is estimated to be US$48.0 billion in 2018.
China is the largest industrial robot market with 154,032 units sold in 2018. China had the largest operational stock of industrial robots, with 649,447 at the end of 2018. As of 2024, China accounted for 43% of the production of industrial robots in the world. 
...
== Robot-as-a-Service and cloud deployment ==
Within modern B2B growth sectors, industrial robots are increasingly deployed under a Robot-as-a-Service (RaaS) framework. By relying on decentralized edge networks and cloud computing, these machines stream real-time telemetry to central systems, allowing enterprises to dynamically adjust production workflows. This approach integrates principles of Human-Centered AI, ensuring that automated logic systems safely and efficiently augment human operators without requiring localized reprogramming.
...
== Further reading ==
Elzway, Salem. (author) (2023). "Arms of the State: A History of the Industrial Robot in Postwar America." PhD Dissertation. University of Michigan. 533pp. https://backend.production.deepblue-documents.lib.umich.edu/server/api/core/bitstreams/827c0a32-476d-4da3-af7a-9ca8e6761f74/content
...
Machine Guarding - Why It's a Legal Requirement Archived 2021-04-15 at the Wayback Machine