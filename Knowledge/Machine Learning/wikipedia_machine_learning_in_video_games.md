...
Source: https://en.wikipedia.org/wiki/Machine%20learning%20in%20video%20games
...
The terrain generation solution implemented in Prologue: Go Wayback! (early access: to be announced, with play tests undergoing in early 2025), a survival game developed by PlayerUnknown Productions. The approach allows to generate a new game map every time the game is launched.
