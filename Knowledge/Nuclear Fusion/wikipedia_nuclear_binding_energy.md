...
Source: https://en.wikipedia.org/wiki/Nuclear%20binding%20energy

Nuclear binding energy in nuclear physics and nuclear engineering is the minimum energy that is required to fully disassemble the nucleus of one atom into its constituent protons and neutrons, known collectively as nucleons. The binding energy for stable nuclei is always a positive number, as the nucleus must gain energy for the nucleons to move apart from each other. Nucleons are attracted to each other by the strong nuclear force. In theoretical nuclear physics, the nuclear binding energy is considered a negative number. In this context it represents the energy of the nucleus relative to the energy of the constituent nucleons when they are infinitely far apart. Both the experimental and theoretical views are equivalent, with slightly different emphasis on what the binding energy means.
...
The best-known classes of exothermic nuclear transmutations are nuclear fission and nuclear fusion. In any exothermic nuclear process, nuclear mass might ultimately be converted to thermal energy, emitted as heat.
Nuclear energy may be released by fission, when heavy atomic nuclei (like uranium and plutonium) are broken apart into lighter nuclei. Fission is used to generate electric power in hundreds of locations worldwide. 
Nuclear energy is also released during fusion, when light nuclei like hydrogen are combined to form heavier nuclei such as helium. The Sun and other stars use nuclear fusion to generate thermal energy which is later radiated from the surface. Additionally, fusion creates many of the heavier elements (see stellar nucleosynthesis). 
...
Unlike gravity or the electric force, the nuclear force is only effective at very short distances. At greater distances, the electrostatic force dominate: the protons repel each other because they are positively charged. For this reason, the protons forming the nuclei of ordinary hydrogen do not combine to form helium in normal conditions; the protons cannot get close enough for the nuclear force, which attracts them to each other, to become important. Furthermore, this process would also require some protons to combine with electrons and become neutrons (see p-p chain and CNO cycle); these processes require very high pressure and temperature to take place, and hence typically only occur in extreme environments such as stellar cores.
...
Nuclear mass defect is defined as the difference between the nuclear mass and the sum of the masses of the constituent nucleons. It is given by
    ...
    {\displaystyle \Delta m=Zm_{p}+(A-Z)m_{n}-M=Zm_{p}+Nm_{n}-M}
...
mp is the mass of a proton, 1.67262192595(52)×10−27 kg‍.
mn is the mass of a neutron, 1.67492750056(85)×10−27 kg‍.
...
The first term 
 ...
 is purely empirical; it is positive for even–even nuclei and negative for odd–odd nuclei. When A is odd, the pairing term is identically zero.
...
== External links ==
 Media related to Nuclear binding energy at Wikimedia Commons